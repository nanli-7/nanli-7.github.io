...
BLOG_AUTHOR = "Nanli-7"  # (translatable)
BLOG_TITLE = "Welcome to Nan's site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://nanli-7.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://shelper.github.io/"
BLOG_EMAIL = "noreply@thisemail.com"
BLOG_DESCRIPTION = "This is Nan's site for data science blogging, learning and sharing"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://www.linkedin.com/in/nanli7/', 'About me', 'icon-user'),
        # ('https://twitter.com/shelpermisc', 'My Twitter', 'icon-twitter'),
        ('https://github.com/nanli-7', 'My Github', 'icon-github'),
    ),
}
